                ...
                <div class="layui-tab-content">
                    <table class="layui-table" lay-skin="nob">
                        ...
                        <tr v-for="(item,index) in dataList" v-bind:key="index">
                            ...
                            <td style="width: 60px;">{{item.shangpinJiliang}}</td>
                            ...
                            <td style="width: 100px;">
                                ...
                                <button v-if="item.shangpinOrderTypes==2" @click="refund(item.id)" type="button" class="layui-btn layui-btn-sm layui-btn-radius layui-btn-warm">
