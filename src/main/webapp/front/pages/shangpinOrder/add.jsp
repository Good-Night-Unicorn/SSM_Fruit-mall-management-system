    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="shangpin.shangpinJiliang" type="text"  readonly="readonly" name="shangpinJiliang" id="shangpinJiliang" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input v-model="shangpin.shangpinTime" type="text"  readonly="readonly" name="shangpinTime" id="shangpinTime" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
