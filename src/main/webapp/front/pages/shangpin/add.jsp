    ...
    <div class="data-add-container">
        ...
        <form class="layui-form layui-form-pane" lay-filter="myForm">
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.shangpinJiliang"--%> type="text" name="shangpinJiliang" id="shangpinJiliang" placeholder="计量单位" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.shangpinTime"--%> type="text" name="shangpinTime" id="shangpinTime" placeholder="商品保质期" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
