    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(shangpinPhotoCell);
                    ...
                    //计量单位
            var shangpinJiliangCell = document.createElement('td');
            shangpinJiliangCell.innerHTML = item.shangpinJiliang;
            row.appendChild(shangpinJiliangCell);
            ...
            row.appendChild(shangpinNewMoneyCell);
                    ...
                    //商品保质期
            var shangpinTimeCell = document.createElement('td');
            shangpinTimeCell.innerHTML = item.shangpinTime;
            row.appendChild(shangpinTimeCell);
