                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangpinJiliangDiv">
                                        <label>计量单位</label>
                                        <input style="width: 450px" id="shangpinJiliang" name="shangpinJiliang" class="form-control"
                                               placeholder="计量单位">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 shangpinTimeDiv">
                                        <label>商品保质期</label>
                                        <input style="width: 450px" id="shangpinTime-input" name="shangpinTime" type="text" class="form-control layui-input">
                                    </div>
...
<script>
    ...
    function dateTimePick() {
        var shangpinTime = laydate.render({
            elem: '#shangpinTime-input'
            ,type: 'datetime'
        });
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#shangpinJiliang").val(ruleForm.shangpinJiliang);
        ...
        $("#shangpinTime-input").val(ruleForm.shangpinTime);
