                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 shangpin">
                                        <label>商品保质期</label>
                                        <input style="width: 450px" id="shangpinTime" name="shangpinTime" class="form-control"
                                               placeholder="商品保质期" readonly>
                                    </div>
...
<script>
    ...
    function shangpinDataBind(){
        ...
        $("#shangpinTime").val(ruleForm.shangpinTime);
